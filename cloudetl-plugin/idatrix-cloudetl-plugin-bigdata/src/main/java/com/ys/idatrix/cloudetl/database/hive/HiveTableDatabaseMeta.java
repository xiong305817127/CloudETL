 ...
 * iDatrxi CloudETL
 */
package com.ys.idatrix.cloudetl.database.hive;
...
/**
 * Hive Database With iDatrix Security Manager.
 * HiveTableDatabaseMeta <br/>
 * @author XH
 * @since 2017年10月26日
 *
 */
@DatabaseMetaPlugin( type = "HIVE3", typeDescription = "Security Hadoop Hbase " )
public class HiveTableDatabaseMeta  extends BaseDatabaseMeta{
	...
	public Connection getConnection(String database) throws HadoopSecurityManagerException{
		return IdatrixSecurityManager.getInstance().getHiveJdbcConnection(database, EnvUtils.getUserId(),this);
	}
}