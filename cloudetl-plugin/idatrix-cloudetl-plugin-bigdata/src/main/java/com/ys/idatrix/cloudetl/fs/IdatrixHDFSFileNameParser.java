...
public class IdatrixHDFSFileNameParser extends URLFileNameParser {

  private static final IdatrixHDFSFileNameParser INSTANCE = new IdatrixHDFSFileNameParser();

  private IdatrixHDFSFileNameParser() {
    super( -1 );
  }

  public static IdatrixHDFSFileNameParser getInstance() {
    return INSTANCE;
  }
