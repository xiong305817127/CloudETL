...
public class CloudDubboConfig implements EnvironmentAware {
	...
	public static final String APPLICATION_NAME = "quality";
	
	// For provider
    public static final String PROVIDER_ANNOTATION_PACKAGE = "com.ys.idatrix.quality.dubbo.service";
    
    // For consumer
    public static final String CONSUMER_ANNOTATION_PACKAGE = "com.ys.idatrix.quality.reference,com.ys.idatrix.quality.dubbo.reference";
    ...
    public ApplicationConfig applicationConfig() {
        ...
        applicationConfig.setOwner("quality");
