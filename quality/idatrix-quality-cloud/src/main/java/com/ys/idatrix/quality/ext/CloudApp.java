 ...
 * iDatrix quality
 */
package com.ys.idatrix.quality.ext;
...
import com.ys.idatrix.quality.def.CloudConst;
import com.ys.idatrix.quality.ext.utils.UnixPathUtil;
import com.ys.idatrix.quality.repository.CloudRepository;
import com.ys.idatrix.quality.repository.xml.metastore.vfsxml.VFSXmlMetaStore;
...
public class CloudApp {
	...
	private void initDatabaseMeta() {
		...
		try {
			...
			// config database
			String name = IdatrixPropertyUtil.getProperty("idatrix.database.name","defaultQualityDatabase");
