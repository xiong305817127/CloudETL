 ...
 * @since 2017-09-05
 */
@Component("SPCertificatesAnalysis")
@Scope("prototype")
public class SPCertificatesAnalysis extends SPBaseAnalysis implements StepParameter, StepDataRelationshipParser ,ResumeStepDataParser{
	
	public enum  STANDARD_CODE  { Card18 , Card15 };
