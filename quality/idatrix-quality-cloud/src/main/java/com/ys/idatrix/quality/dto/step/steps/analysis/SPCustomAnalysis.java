 ...
 * @since 2017-09-05
 */
@Component("SPCustomAnalysis")
@Scope("prototype")
public class SPCustomAnalysis extends SPBaseAnalysis implements StepParameter, StepDataRelationshipParser ,ResumeStepDataParser{
