...
public class CloudLogger {
	...
	private final static String LOG_NAME = "quality";
	private final static String DEFAULT_LOGGER_NAME = "iDatrixQualityLog";
	private final static String LOGGER_PREFIX = "cloud_logger_for_";
	private final static String DEFAULT_LOGGER_TEXT_HEAD = "Quality ";
