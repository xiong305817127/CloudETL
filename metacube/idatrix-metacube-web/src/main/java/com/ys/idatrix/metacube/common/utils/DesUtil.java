...
public class DesUtil {
    ...
    public static void main(String[] args) throws Exception {
        String key = "12345678";
        String message = "37af6fac85d92ae707af139258f8119f";
        System.out.println("解密：" + DesUtil.decrypt(message, key, "GBK"));
        String test = "admin";
        String encryptTest = DesUtil.encrypt(test, key, "UTF-8");
        System.out.println("encryptTest:" + encryptTest);
        System.out.println("decrypt:" + DesUtil.decrypt(encryptTest, key, "utf-8"));
