...
public final class CommonConstants {
	...
	public static final Integer EC_SEARCH_PARAM_ERROR = 501;				//输入参数校验失败
	public static final Integer EC_SEARCH_NO_AUTH_ERROR = 503;				//无调用权限
	public static final Integer EC_SEARCH_CALL_FAILURE = 505;				//调用失败
	...
	public static final String SQL_QUERY_STATUS_SUCCESS = "success";		//订阅查询请求结果成功
	public static final String SQL_QUERY_STATUS_FAIL = "fail";				//订阅查询请求结果失败
	public static final String SQL_QUERY_STATUS_WAIT = "wait";				//订阅查询请求结果等待
