...
/**
 * A collection of configuration objects for a Sqoop job entry.,等效 org.pentaho.big.data.kettle.plugins.sqoop.SqoopConfig
 */
public abstract class SqoopConfig {
	...
	// Properties to support toggling between quick setup and advanced mode in the
	// UI. These should never be saved.
...
//	private transient NamedCluster namedCluster;
	...
	private Map<String,String> customArgumentsMap;
...
//		pcs.firePropertyChange(propertyName, oldValue, newValue);
	...
	public void setOptionallyEnclosedBy(String optionallyEnclosedBy) {
		this.optionallyEnclosedBy = propertyChange(OPTIONALLY_ENCLOSED_BY, this.optionallyEnclosedBy,
	...
	public void setInputFieldsTerminatedBy(String inputFieldsTerminatedBy) {
		this.inputFieldsTerminatedBy = propertyChange(INPUT_FIELDS_TERMINATED_BY, this.inputFieldsTerminatedBy,
	...
	public void setInputLinesTerminatedBy(String inputLinesTerminatedBy) {
		this.inputLinesTerminatedBy = propertyChange(INPUT_LINES_TERMINATED_BY, this.inputLinesTerminatedBy,
	...
	public void setInputOptionallyEnclosedBy(String inputOptionallyEnclosedBy) {
		this.inputOptionallyEnclosedBy = propertyChange(INPUT_OPTIONALLY_ENCLOSED_BY, this.inputOptionallyEnclosedBy,
				inputOptionallyEnclosedBy);
	}
	...
	public void setValidationFailureHandler(String validationFailureHandler) {
		this.validationFailureHandler = propertyChange(VALIDATION_FAILURE_HANDLER, this.validationFailureHandler,
	...
	public void setHcatalogPartitionKeys(String hcatalogPartitionKeys) {
		this.hcatalogPartitionKeys = propertyChange(HCATALOG_PARTITION_KEYS, this.hcatalogPartitionKeys,
				hcatalogPartitionKeys);
	}
	...
	public void setHcatalogPartitionValues(String hcatalogPartitionValues) {
		this.hcatalogPartitionValues = propertyChange(HCATALOG_PARTITION_VALUES, this.hcatalogPartitionValues,
				hcatalogPartitionValues);
	}
	...
	public  Map<String, String> getCustomArgumentsMap() {
		if (customArgumentsMap == null) {
			customArgumentsMap = Maps.newHashMap();
		}
		return customArgumentsMap;
	}

	public void setCustomArgumentsMap(Map<String, String> customArguments) {
		this.customArgumentsMap = customArguments;
	}
