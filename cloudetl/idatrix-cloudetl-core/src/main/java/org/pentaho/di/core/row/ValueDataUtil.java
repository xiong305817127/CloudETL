...
public class ValueDataUtil {
  ...
  public static String getDigits( ValueMetaInterface metaA, Object dataA ) {
    ...
    if(metaA.isNumber() || metaA.isBigNumber()) {
    	return Const.getNumberOnly( dataA.toString() );
    }else if( metaA.isDate()) {
    	return Const.getDateStringOnly( dataA.toString() , metaA.getConversionMask() );
    }
