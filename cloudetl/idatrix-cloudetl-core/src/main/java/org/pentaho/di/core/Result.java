...
public class Result implements Cloneable {
  ...
  public String getXML() {
    try {
      ...
      //xionghan
      boolean sendResultXmlWithFile = EnvUtil.getSystemProperty( "KETTLE_COMPATIBILITY_SEND_RESULT_XML_WITH_FILE", "Y" ).equalsIgnoreCase( "Y" );
      if(sendResultXmlWithFile) {
      ...
      //xionghan
      boolean sendResultXmlWithRow = EnvUtil.getSystemProperty( "KETTLE_COMPATIBILITY_SEND_RESULT_XML_WITH_ROW", "Y" ).equalsIgnoreCase( "Y" );
      if(sendResultXmlWithRow) {
  ...
  private StringBuilder setBasicXmlAttrs( StringBuilder xml ) {
    ...
    //xionghan
    xml.append( XMLHandler.addTagValue( "successFailTimes", successFailTimes ) );
  ...
  public Result( Node node ) throws KettleException {
    ...
    //xiongahn
    successFailTimes = XMLHandler.getTagValue( node, "successFailTimes" );
...
public void increaseTimes(boolean isSuccess) {
	...
	if( !Utils.isEmpty( successFailTimes ) ) {
		String[] sfSplit = successFailTimes.split("/");
