...
public class GetTransStatusServlet extends BaseHttpServlet implements CartePluginInterface {
  ...
  public void doGet( HttpServletRequest request, HttpServletResponse response ) throws ServletException,
    ...
    if ( trans != null ) {
      ...
      //xionghan startLineNr<0时 使用云日志
      String logText = startLineNr < 0 ? trans.getCloudLog() :
      ...
      if ( useXML ) {
        ...
        transStatus.setCloudLog(trans.getCloudLog());
        transStatus.setPartLog(trans.getCloudPartLog());
