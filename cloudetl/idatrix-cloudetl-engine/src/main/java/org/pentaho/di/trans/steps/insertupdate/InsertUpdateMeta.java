...
public class InsertUpdateMeta extends BaseStepMeta implements StepMetaInterface, ProvidesModelerMeta {
  ...
  private void readData( Node stepnode, List<? extends SharedObjectInterface> databases ) throws KettleXMLException {
    ...
    try {
      ...
      //xionghan
      syncFlagFieldName = XMLHandler.getTagValue( stepnode, "syncFlagFieldName" );
      syncTimeFieldName = XMLHandler.getTagValue( stepnode, "syncTimeFieldName" );
  ...
  public String getXML() {
    ...
    //xionghan
    retval .append( "    " ).append( XMLHandler.addTagValue( "syncFlagFieldName", syncFlagFieldName) );
    retval .append( "    " ).append( XMLHandler.addTagValue( "syncTimeFieldName", syncTimeFieldName) );
  ...
  public void readRep( Repository rep, IMetaStore metaStore, ObjectId id_step, List<DatabaseMeta> databases ) throws KettleException {
    ...
    try {
      ...
      //xionghan
      syncFlagFieldName = rep.getStepAttributeString( id_step, "syncFlagFieldName" );
      syncTimeFieldName = rep.getStepAttributeString( id_step, "syncTimeFieldName" );
  ...
  public void saveRep( Repository rep, IMetaStore metaStore, ObjectId id_transformation, ObjectId id_step ) throws KettleException {
    try {
      ...
      //xionghan
      rep.saveStepAttribute( id_transformation, id_step, "syncFlagFieldName", syncFlagFieldName );
      rep.saveStepAttribute( id_transformation, id_step, "syncTimeFieldName", syncTimeFieldName );
