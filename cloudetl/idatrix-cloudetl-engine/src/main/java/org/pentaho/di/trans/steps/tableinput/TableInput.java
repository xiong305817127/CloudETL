...
public class TableInput extends BaseStep implements StepInterface {
  ...
  public RowMetaAndData readStartDate() throws KettleException {
    if ( log.isDetailed() ) {
  ...
  public boolean doQuery( RowMetaInterface parametersMeta, Object[] parameters ) throws KettleDatabaseException {
