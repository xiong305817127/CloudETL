 ...
 */
import qs from 'qs';
import { API_BASE_CATALOG,API_BASE_METADATA,API_BASE_SECURITY } from '../constants';
...
export async function getAllOrgs(query) {
  ...
  return request(`${API_BASE_SECURITY}/organization/getAllOrgs.do?${querystring}`);
}
//调用安全角色接口
...
export async function queryMetaDataByDsId(query) {
  const querystring = qs.stringify(query);
  return request(`${API_BASE_METADATA}/metadataTable/ds/queryByDsId?${querystring}`);
}
...
export async function getDatabaseList(query) {
  ...
  return request(`${API_BASE_METADATA}/dataSwap/getDatabasesByUserIdDsType?${querystring}`);
}
...
export async function getDatabaseListByRentId(query) {
  ...
  return request(`${API_BASE_METADATA}/dataSwap/getDatabasesByRentIdDsType?${querystring}`);
}
//获得表名
export async function getTableList(query) {
  const querystring = qs.stringify(query);
  return request(`${API_BASE_METADATA}/dataSwap/getTablesByRentIdDsName?${querystring}`);
}
//获得字段名
export async function getFieldList(query) {
  const querystring = qs.stringify(query);
  return request(`${API_BASE_METADATA}/dataSwap/getFieldsByMetaId?${querystring}`);
}
...
export async function getResourceFile(query) {
  const querystring = qs.stringify(query);
  return request(`${API_BASE_CATALOG}/dataUpload/getResourceFile?${querystring}`);
}
...
export async function getSubtreeAndDepth(query){
  const querystring = qs.stringify(query);
  return request(`${API_BASE_CATALOG}/classify/getSubtreeAndDepth?${querystring}`)
}
