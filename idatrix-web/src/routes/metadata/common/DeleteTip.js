...
import { delete_front_server,delete_database_table_fields,delete_ftp_table_fields,export_table_struct,delete_table_struct,new_table_struct } from '../../../services/metadata'
    ...
    if(currentSelected.length === 0){
      ...
      if(model === "mfserver"){
        ...
        delete_ftp_table_fields(args).then((res)=>{
          ...
          console.log(args);
        console.log(this.props.deletetip);
