...
class NewModelShip extends React.Component{
  state = {
    pagination:{
      current:1,
      pageSize:10
   ...
   search = (record) =>{
    ...
    onDrop=(event, node, dragNode, dragNodesKeys)=>{
       console.log(event, node, dragNode, dragNodesKeys,"onDrop=======");
    }
    onDragLeave=(event, node)=>{
       console.log(event, node,"onDragLeave=======");
    }
    ...
    const { metadataBase,dataLeft,actionType } = this.props.drmnewfilemodel;
     ...
     return(
       <div className={Style.DataRelationshipManagementStyle} >
           ...
           */}
          <div style={{color:'red'}}>dfdfdfdddddddddddddddd</div>
