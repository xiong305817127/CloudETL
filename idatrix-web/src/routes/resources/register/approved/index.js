...
const index = ({form,dispatch,approvedModel,location,router})=>{

  const {getFieldDecorator} = form;
  const {total,datasource,CheckHistoryShow,loading,datasource2,selectName} = approvedModel;
...
export default connect(({ approvedModel })=>({ approvedModel }))(withRouter(Form.create()(index)));