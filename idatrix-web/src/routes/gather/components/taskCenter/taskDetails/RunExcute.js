...
const Excute = ({ taskdetails, dispatch }) => {

	const { visible2 } = taskdetails;
	const { engineName, engineType, clearingLog, safeMode, gatherMetrics, rebootAutoRun, logLevel, breakpointsRemote, breakpointsContinue,params } = taskdetails.excute;
