...
const DomShow = ({ items, dispatch, cloudetlCommon, owner }) => {
  ...
  switch (items.panel){
    case "CharacterAnalysis": return ( <CharacterAnalysis model={items} />); 
    case "NumberAnalysis": return ( <NumberAnalysis model={items} />); 
    case "CertificatesAnalysis": return ( <CertificatesAnalysis model={items} />); 
    case "DateAnalysis": return ( <DateAnalysis model={items} />); 
    case "AnalysisReport": return ( <AnalysisReport model={items} />); 
    case "TableInput": return ( <TableInput model={items} />); 
    case "TableOutput": return ( <TableOutput model={items} />); 
    case "ExecSQL": return ( <ExecSQL model={items} />); 
    case "ScriptValueMod": return ( <ScriptValueMod model={items} />); 
    case "TextFileOutput": return ( <TextFileOutput model={items} />); 
    case "TextFileInput": return ( <TextFileInput model={items} />); 
    case "InsertUpdate": return ( <InsertUpdate model={items} />); 
    case "GetFileNames": return ( <GetFileNames model={items} />); 
    case "CsvInput": return ( <CsvInput model={items} />); 
    case "AccessInput": return ( <AccessInput model={items} />); 
    case "ExcelInput": return ( <ExcelInput model={items} />); 
    case "HadoopFileInputPlugin": return ( <HadoopFileInputPlugin model={items} />); 
    case "HadoopFileOutputPlugin": return ( <HadoopFileOutputPlugin model={items} />); 
    case "ClosureGenerator": return ( <ClosureGenerator model={items} />); 
    case "GetSlaveSequence": return ( <GetSlaveSequence model={items} />); 
    case "ValueMapper": return ( <ValueMapper model={items} />); 
    case "SplitFieldToRows3": return ( <SplitFieldToRows3 model={items} />); 
    case "Denormaliser": return ( <Denormaliser model={items} />); 
    case "StringCut": return ( <StringCut model={items} />); 
    case "ConcatFields": return ( <ConcatFields model={items} />); 
    case "Unique": return ( <Unique model={items} />); 
    case "UniqueRowsByHashSet": return ( <UniqueRowsByHashSet model={items} />); 
    case "Constant": return ( <Constant model={items} />); 
    case "Sequence": return ( <Sequence model={items} />); 
    case "CheckSum": return ( <CheckSum model={items} />); 
    case "SelectValues": return ( <SelectValues model={items} />); 
    case "StringOperations": return ( <StringOperations model={items} />); 
    case "ReplaceString": return ( <ReplaceString model={items} />); 
    case "SetValueConstant": return ( <SetValueConstant model={items} />); 
    case "FieldSplitter": return ( <FieldSplitter model={items} />); 
    case "SortRows": return ( <SortRows model={items} />); 
    case "SetValueField": return ( <SetValueField model={items} />); 
    case "Calculator": return ( <Calculator model={items} />); 
    case "Normaliser": return ( <Normaliser model={items} />); 
    case "Flattener": return ( <Flattener model={items} />); 
    case "FieldsChangeSequence": return ( <FieldsChangeSequence model={items} />); 
    case "NumberRange": return ( <NumberRange model={items} />); 
    case "AddXML": return ( <AddXML model={items} />); 
    case "SPECIAL": return ( <START model={items} />); 
    case "SUCCESS": return ( <SUCCESS model={items} />); 
    case "EVAL": return ( <EVAL model={items} />); 
    case "DELAY": return ( <DELAY model={items} />); 
    case "HadoopCopyFilesPlugin": return ( <HadoopCopyFilesPlugin model={items} />); 
    case "SET_VARIABLES": return ( <Variables model={items} />); 
    case "SIMPLE_EVAL": return ( <SIMPLE_EVAL model={items} />); 
    case "SFTP": return ( <SFTP model={items} />); 
    case "SFTPPUT": return ( <SFTPPUT model={items} />); 
    case "COPY_FILES": return ( <COPY_FILES model={items} />); 
    case "JOB": return ( <JOB model={items} />); 
    case "TRANS": return ( <TRANS model={items} />); 
    case "DUMMY": return false; 
    case "ElasticSearchBulk": return ( <ElasticSearchBulk model={items} />); 
    case "HBaseOutput": return ( <HBaseOutput model={items} />); 
    case "HBaseInput": return ( <HBaseInput model={items} />); 
    case "StreamLookup": return ( <StreamLookup model={items} />); 
    case "SwitchCase": return ( <SwitchCase model={items} />); 
    case "GroupBy": return ( <GroupBy model={items} />); 
    case "Validator": return ( <Validator model={items} />); 
    case "HTTP": return ( <HttpClient model={items} />); 
    case "HTTPPOST": return ( <HttpPost model={items} />); 
    case "Rest": return ( <RestClient model={items} />); 
    case "WebServiceLookup": return ( <WebServiceLookup model={items} />); 
    case "JsonInput": return ( <JsonInput model={items} />); 
    case "JsonOutput": return ( <JsonOutput model={items} />); 
    case "FuzzyMatch": return ( <FuzzyMatch model={items} />); 
    case "DBProc": return ( <DBProc model={items} />); 
    case "DynamicSQLRow": return ( <DynamicSQLRow model={items} />); 
    case "SqoopExport": return ( <SqoopExport model={items} />); 
    case "SqoopImport": return ( <SqoopImport model={items} />); 
    case "UNKNOWN": return ( <Unknown model={items} />); 
    case "SHELL": return ( <Shell model={items} />); 
    case "FilterRows": return ( <FilterRows model={items} />); 
    case "MergeRows": return ( <MergeRows model={items} />); 
    case "Dummy": return ( <Dummy model={items} />); 
    case "RowGenerator": return ( <RowGenerator model={items} />); 
    case "MultiwayMergeJoin": return ( <MultiwayMergeJoin model={items} />); 
    case "MergeJoin": return ( <MergeJoin model={items} />); 
    case "SortedMerge": return ( <SortedMerge model={items} />); 
    case "GetVariable": return ( <GetVariable model={items} />); 
    case "JoinRows": return ( <JoinRows model={items} />); 
    case "SystemInfo": return ( <SystemInfo model={items} />); 
    case "SetVariable": return ( <SetVariable model={items} />); 
    case "DBLookup": return ( <DBLookup model={items} />); 
    case "ParquetInput": return ( <ParquetInput model={items} />); 
    case "ParquetOutput": return ( <ParquetOutput model={items} />); 
    case "Formula": return ( <Formula model={items} />); 
    case "ReadContentInput": return ( <ReadContentInput model={items} />);
    case "ExcelOutput": return ( <ExcelOutput model={items} />);
    case "RegexEval": return ( <RegexEval model={items} />);
    case "KafkaConsumerInput": return ( <KafkaConsumerInput model={items} />);
    case "KafkaProducerOutput": return ( <KafkaProducerOutput model={items} />);
    case "RecordsFromStream": return ( <RecordsFromStream model={items} />);
    case "Desensitization": return ( <Desensitization model={items} />);
    default:     
      return (
