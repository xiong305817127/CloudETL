...
import { Form,Select,Button,Input,Checkbox, notification,Tabs,Row,Col,message } from 'antd';
...
class HadoopOutputDialog extends React.Component {
  ...
  getFieldList(name){
    ...
    let path =  getFieldValue("sourceConfigurationName");
  ...
  render() {
    ...
    const { visible,config,text,handleCheckName,handleCheckPathName } = this.props.model;
          ...
          <div style={{margin:"0 5%"}}>
            <Tabs type="card">
              <TabPane tab="文件" key="1">
                ...
                >
                    {getFieldDecorator('sourceConfigurationName', {
                      ...
                      <Select >
                        {
                          this.state.hadoop_list.map((index)=>
                ...
                <FormItem label="目录/文件"  {...this.formItemLayout1}>
                  {getFieldDecorator('fileName', {
                    ...
                    rules: [{validator:handleCheckPathName,message: '请输入完整路径！' }]
                  })(
                    <Input disabled={setDisabled2()}/>
                  )}
                  <Button disabled={setDisabled2()} onClick={()=>{this.getFieldList("model")}}>浏览</Button>
                </FormItem>
                  ...
                  <Col span={12}>
                    <FormItem  style={{marginBottom:"0px"}} {...this.formItemLayout}>
                      {getFieldDecorator('createParentFolder', {
                        ...
                        <Checkbox disabled={setDisabled2()}>创建父目录</Checkbox>
                      )}
                    </FormItem>
                  </Col>
                  <Col span={12}>
                    <FormItem  style={{marginBottom:"0px"}} {...this.formItemLayout}>
                      {getFieldDecorator('doNotOpenNewFileInit', {
                        ...
                        <Checkbox disabled={setDisabled2()}>启动时不创建文件</Checkbox>
                      )}
                    </FormItem>
                  </Col>
                </Row>
                ...
                <FormItem label="文件名字段"   style={{marginBottom:"8px"}} {...this.formItemLayout1}>
                  {getFieldDecorator('fileNameField', {
                    ...
                    <Select disabled={!setDisabled2()} onFocus={()=>{this.handleGetFields("input")}}>
                      {
                  ...
                  <Col span={12}>
                    <FormItem  style={{marginBottom:"0px"}} {...this.formItemLayout}>
                      {getFieldDecorator('stepNrInFilename', {
                        ...
                        <Checkbox disabled={setDisabled2()}>文件名里包含步骤数？</Checkbox>
                      )}
                    </FormItem>
                  </Col>
                  <Col span={12}>
                    <FormItem  style={{marginBottom:"0px"}} {...this.formItemLayout}>
                      {getFieldDecorator('haspartno', {
                        ...
                        <Checkbox disabled={setDisabled2()}>文件名里包含数据分区号？</Checkbox>
                      )}
                    </FormItem>
                  </Col>
                </Row>
                  ...
                  <Col span={12}>
                    <FormItem  style={{marginBottom:"0px"}} {...this.formItemLayout}>
                      {getFieldDecorator('addDate', {
                        ...
                        <Checkbox disabled={setDisabled2() || setDisabled3()}>文件名里包含日期？</Checkbox>
                      )}
                    </FormItem>
                  </Col>
                  <Col span={12}>
                    <FormItem  style={{marginBottom:"0px"}} {...this.formItemLayout}>
                      {getFieldDecorator('addTime', {
                        ...
                        <Checkbox disabled={setDisabled2() || setDisabled3()}>文件名里包含时间？</Checkbox>
                      )}
                    </FormItem>
                  </Col>
                </Row>
                  ...
                  <Col span={12}>
                    <FormItem  style={{marginBottom:"0px"}} {...this.formItemLayout}>
                      {getFieldDecorator('specifyFormat', {
                        ...
                        <Checkbox disabled={setDisabled2()}  >指定日期时间格式？</Checkbox>
                      )}
                    </FormItem>
                  </Col>
                  <Col span={12}>
                    <FormItem  style={{marginBottom:"0px"}} {...this.formItemLayout}>
                      {getFieldDecorator('addToResultFilenames', {
                        ...
                        <Checkbox disabled={setDisabled2()}>结果中添加文件名？</Checkbox>
                      )}
                    </FormItem>
                  </Col>
                </Row>
              ...
              <TabPane tab="内容" key="2">
                ...
                <FormItem label="分隔符"   style={{marginBottom:"8px"}} {...this.formItemLayout2}>
              ...
              <TabPane tab="字段" key="3">
                <div >
                  <Row style={{margin:"5px 0",width:"100%"}}  >
                    ...
                    <Col span={12}>
                      <ButtonGroup  size={"small"} >
                        ...
                        <Button  onClick={()=>{this.handleGetFields("table")}} >获取字段</Button>
                      </ButtonGroup>
                    </Col>
                  ...
                  <EditTable  columns={this.columns} rowSelection={true} dataSource = {this.state.dataSource} tableStyle="editTableStyle5" size={"small"} scroll={{y: 140,x:1000}} ref="editTable"   count={4}/>
                </div>
              </TabPane>
            </Tabs>
            <HadoopOutputModel />
...
export default connect()(HadoopFileOutput);
