...
const DbTable = ({analysisDbtable,dispatch})=>{
    const {visible,connection,schema,tableList,loading,fuc,tableFields,selectKeys,tablename,dataType,schemalist,loading1} = analysisDbtable;
 ...
 const handleHide = ()=>{
  ...
  const handleChange = (e)=>{
      selectKeys.splice(0);
     dispatch({
        type:'analysisDbtable/queryTable',
        payload:{
