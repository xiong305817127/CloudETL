...
class ExcelDialog extends React.Component {
  ...
  render() {
    ...
    const { path, useFolder, tableNames, excelVisible } = this.state;
    ...
    return (
      ...
      >
          ...
          <div style={{ margin: "0 5%" }}>
            <Tabs type="card">
                ...
                <div className="tableLimitArea">
                  ...
                  <Row style={{ lineHeight: "40px" }}>
                    ...
                    <Col span={8} >
                      ...
                      <Button disabled={setDisabled()} onClick={() => { this.handleFileUpload("list") }} disabled={!useFolder}>上传</Button>
                    </Col>
                  </Row>
                  <Row style={{ width: "100%" }}>
                    <Col span={12}>
              ...
              <TabPane tab="工作表" key="2">
                ...
                <EditTable columns={this.sheetColumns} rowSelection={true} dataSource={this.state.sheetSource} size={"small"} scroll={{ y: 140 }} ref="sheetTable" count={4} />
              </TabPane>
        ...
        <ExcelInputModel visible={excelVisible} handleHide={this.handleHide.bind(this)}
          tableNames={tableNames} handleSheetUpdate={this.handleSheetUpdate.bind(this)} />
      </Modal>
    );
