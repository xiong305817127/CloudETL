...
// premit:["quality","bi"]
// 1、 quality(质量权限) 2、bi(BI权限) 3、shen(跳神算子)  shen DIVINE_URL 神算子链接(用户为当前登录系统的用户，不需要配置)
...
// 10、dataViewTools  DATAVIEWTOOLS_URL 可视化工具
var CUSTOM_PARAMS = {
  SITE_NAME: "灵机大数据111111",
  premit: ["dataMap", "bbsPage", "dataView", "bi", "dataViewTools","quality","shen", "portalPage", "kibanaPage", "logAnalysis"],
  BBS_URL: "http://10.0.0.85:60130/",
	...
	DIVINE_URL:"http://113.207.110.254:8088/home/recommend/guide",
	DATAVIEWTOOLS_URL:"http://www.baidu.com"
};
