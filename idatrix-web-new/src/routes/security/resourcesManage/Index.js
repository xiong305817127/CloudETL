...
class ResourcesManagingTable extends React.Component {
  ...
  handleRadioChange = e => {
    this.setState({
      radioIsSelectedOnLink: e.target.value === "中转站"
    });
  };
            ...
            <Form>
              ...
              <FormItem {...formItemLayout} label="类型：">
                {getFieldDecorator("type", {
                  ...
                  >
                    <Radio value="菜单" disabled={resourceView.type === "系统"}>
                      菜单
                    </Radio>
                    <Radio value="按钮" disabled={resourceView.type === "系统"}>
                      按钮
                    </Radio>
                    <Radio value="系统" disabled={resourceView.type !== "系统"}>
                      系统
                    </Radio>
                    <Radio
                      value="中转站"
                      disabled={resourceView.type === "系统"}
                    >
                      中转站
                    </Radio>
                  </Radio.Group>
              ...
              <FormItem {...formItemLayout} label="URL：">
                {getFieldDecorator("url", {
                  ...
                  rules: [
                    {
                      required:
                        resourceView.type === "菜单" ||
                        resourceView.type === "按钮",
                      whitespace: true,
                      message: "请输入URL"
                    }
                  ]
              ...
              {this.state.radioIsSelectedOnLink && (
                <FormItem {...formItemLayout} label="中转站：">
                  {getFieldDecorator("redirectUrl", {
                    initialValue: resourceView.url || "",
                    rules: [
                      {
                        required: this.state.radioIsSelectedOnLink,
                        whitespace: true,
                        message: "请输入重定向链接"
                      }
                    ]
              ...
              <div>
                <Empower api="/permission/update.shtml">
                  <Button
                    disabled={Object.keys(resourceView).length === 0}
                    type="primary"
