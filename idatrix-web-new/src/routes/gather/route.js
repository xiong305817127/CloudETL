...
// 数据质量首页
const QualityAnalysisIndexPage = resolve => require(["./qualityAnalysis/indexPage"], resolve);
const QualityAnalysisIndexPageModel = resolve => require(["./qualityAnalysis/indexPage/model"], resolve);

// 稽核4w页面
const QualityAduit4WPage = resolve => require(["./qualityAnalysis/aduit4W"], resolve);
const QualityAduit4WPageModel = resolve => require(["./qualityAnalysis/aduit4W/model"], resolve);
...
//数据评估  五张图表
const reportindex = resolve => require(['./qualityAnalysis/DataOverview/index'], resolve);
const indexViewOne = resolve => require(['./qualityAnalysis/DataOverview/indexViewOne'], resolve);
const indexViewTwo = resolve => require(['./qualityAnalysis/DataOverview/indexViewTwo'], resolve);
const indexViewThere = resolve => require(['./qualityAnalysis/DataOverview/indexViewThere'], resolve);
const indexViewFour = resolve => require(['./qualityAnalysis/DataOverview/indexViewFour'], resolve);
const indexViewFives = resolve => require(['./qualityAnalysis/DataOverview/indexViewFives'], resolve);
const DataOverviewModel = resolve => require(['./qualityAnalysis/DataOverview/model'], resolve);
        ...
        routes: [
          {
            ...
            models:[DataOverviewModel],
						empowerApi: '/gather/qualityAnalysis/index',
          },{
            path: '/gather/qualityAnalysis/indexViewOne',
            name: 'indexViewOne',
            breadcrumbName: '数据采集&集成',
            component: indexViewOne,
            models:[DataOverviewModel],
						empowerApi: '/gather/qualityAnalysis/indexViewOne',
          },{
            path: '/gather/qualityAnalysis/indexViewTwo',
            name: 'indexViewTwo',
            breadcrumbName: '数据共享交换',
            component: indexViewTwo,
            models:[DataOverviewModel],
						empowerApi: '/gather/qualityAnalysis/indexViewTwo',
          },{
            path: '/gather/qualityAnalysis/indexViewThere',
            name: 'indexViewThere',
            breadcrumbName: '数据分析&探索BI',
            component: indexViewThere,
            models:[DataOverviewModel],
						empowerApi: '/gather/qualityAnalysis/indexViewThere',
          },{
            path: '/gather/qualityAnalysis/indexViewFour',
            name: 'indexViewFour',
            breadcrumbName: '日志统计表',
            component: indexViewFour,
            models:[DataOverviewModel],
						empowerApi: '/gather/qualityAnalysis/indexViewFour',
          },
          {
            path: '/gather/qualityAnalysis/indexViewFives',
            name: 'indexViewFives',
            breadcrumbName: '神算子平台报表',
            component: indexViewFives,
            models:[DataOverviewModel],
						empowerApi: '/gather/qualityAnalysis/indexViewFives',
          },
					{
            path: '/gather/qualityAnalysis/indexPage',
            name: 'indexPage',
            breadcrumbName: '数据总览',
						component: QualityAnalysisIndexPage,
						models:[QualityAnalysisIndexPageModel],
						empowerApi: '/gather/qualityAnalysis/indexPage',
					},
					{
            path: '/gather/qualityAnalysis/aduit4W',
            name: 'aduit4W',
            breadcrumbName: '数据总览',
						component: QualityAduit4WPage,
						models:[QualityAduit4WPageModel],
						empowerApi: '/gather/qualityAnalysis/aduit4W',
          },
          {
