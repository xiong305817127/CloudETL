...
class ParquetOutput extends React.Component {
  ...
  render() {
    ...
    const show = getFieldValue("sourceConfigurationName") === hadoopName;
    ...
    return (
      ...
      >
        <Form>
          ...
          >
            {getFieldDecorator("sourceConfigurationName", {
              ...
              <Select>
                ...
                <Option key={hadoopName} value={hadoopName}>
                  {hadoopName}
                </Option>
              </Select>
            )}
          ...
          <FormItem
            style={{ marginBottom: "0px", marginLeft: "78px" }}
            {...formItemLayout1}
          >
              ...
              <Row>
                ...
                <Col span={12}>
                  <ButtonGroup size={"small"} style={{ float: "right" }}>
                    ...
                    <Button size={"small"} onClick={this.getFields.bind(this)}>
                      获取字段
                    </Button>
                  </ButtonGroup>
                </Col>
                ...
                <Col span={12}>
                  ...
                  >
                    {getFieldDecorator("compressionType", {
                      initialValue: config.compressionType
                      ...
                      <Select>
                        ...
                        <Option key="SNAPPY" value="SNAPPY">
                          Snappy
                        </Option>
                ...
                <Col span={12}>
                  ...
                  >
                    {getFieldDecorator("parquetVersion", {
                      initialValue: config.parquetVersion
                        ? config.parquetVersion
                        : "PARQUET_1"
                    })(
                      <Select>
                        <Option key="PARQUET_1" value="PARQUET_1">
                          Parquet 1.0
                        </Option>
                        <Option key="PARQUET_2" value="PARQUET_2">
                          Parquet 2.0
                        </Option>
                      </Select>
                    )}
                  ...
                  >
                    {getFieldDecorator("dateTimeFormat", {
                      ...
                      <Select disabled={!setDisabled()}>
                        <Option key="yyyyMMddHHmmss" value="yyyyMMddHHmmss">
                          yyyyMMddHHmmss
                        </Option>
                        ...
                        <Option key="MM-dd-yy" value="MM-dd-yy">
                          MM-dd-yy
                        </Option>
                        <Option key="dd-MM-yyyy" value="dd-MM-yyyy">
                          dd-MM-yyyy
                        </Option>
                      </Select>
                    )}
