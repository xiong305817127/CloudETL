...
import { Button, Form, Input,Select,Checkbox,Row,Col,message } from 'antd';
    ...
    return (
      ...
      >
        <Form >
          ...
          <FormItem label="文件模板"   style={{marginBottom:"8px"}} {...this.formItemLayout1}>
            <div>
          ...
          <FormItem label="文件"   style={{marginBottom:"8px"}} {...this.formItemLayout1}>
            <div>
              {getFieldDecorator('filename', {
                ...
                <Button  title="只能上传到默认目录" onClick={()=>{this.handleFileUpload("list")}}>上传</Button>
            </div>
          </FormItem>
					<p style={{ textAlign:"center" }} >浏览：可输入浏览的根目录，默认为：{path}</p>
          <FormItem label="列分隔符"   {...this.formItemLayout1}>
            <div>
