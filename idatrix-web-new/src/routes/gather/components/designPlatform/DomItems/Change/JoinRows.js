...
class JoinRows extends React.Component {
    ...
    return (
      <Modal
        ...
        <Form >
          ...
          <FormItem label="临时目录"   style={{marginBottom:"8px"}}  {...formItemLayout1}>
          ...
          <FormItem label="临时文件前缀"   style={{marginBottom:"8px"}}  {...formItemLayout1}>
          ...
          <FormItem label="最大缓存大小(记录行)"   style={{marginBottom:"8px"}}  {...formItemLayout1}>
          ...
          <FormItem label="Main step to read from"   style={{marginBottom:"8px"}}  {...formItemLayout1}>
            {getFieldDecorator('mainStep', {
              initialValue:config.mainStep,
            })(
              <Select allowClear>
                      {
                  ...
                  initialValue: config.condition.rightExactText,
                       ...
                       <div>
                            {this.state.InputDataS === "Number" ?(
                             <Select key="key" allowClear style={{ width: 200 }}>
...
const JoinRowsList = Form.create()(JoinRows);

export default connect()(JoinRowsList);
