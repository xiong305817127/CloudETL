...
class Sqoop extends React.Component {
  ...
  handleCreate = e => {
    ...
    this.props.form.validateFields((err, values) => {
      ...
      paramsObj.targetDir = targetDir ? targetDir : getFieldValue("targetDir");
  ...
  getFieldList() {
    ...
    let str = hadoopName;
    let str1 = formatFolder(getFieldValue("targetDir"));
  ...
  handleChangeModel() {
    ...
    if (model === "simple") {
      const { table, targetDir } = getFieldsValue(["table", "targetDir"]);
      let newObj = {
        ...defaultObj,
        table: table,
        targetDir: targetDir
            ...
            <div>
                    ...
                    {getFieldDecorator("schema", {
                      ...
                      >
                        {schemaList.map(index => (
                          <Option key={index.schemaId} value={index.schemaId}>
                            {index.schema}
                          </Option>
                        ))}
                      </Select>
              ...
              <fieldset className="ui-fieldset">
                ...
                <FormItem
                  ...
                  style={{ marginBottom: 8 }}
                >
                  {getFieldDecorator("targetDir", {
                    initialValue: targetDir ? targetDir : ""
...
const SqoopImport = Form.create()(Sqoop);
export default connect()(
  withDatabase(
    withHdfs(SqoopImport, {
			isRead: true,
			width:360
    }),
    {
