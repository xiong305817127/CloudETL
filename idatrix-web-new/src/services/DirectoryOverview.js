...
export async function MLZYgetAllSourceServicePages(query) {
  const querystring = qs.stringify(query);
  return request(
    `${API_BASE_CATALOG}/srcService/getAllSourceServicePages?${querystring}`
  );
}
/*源服务删除*/
export async function MLZYdeleteSourceServiceById(query) {
  const querystring = qs.stringify(query);
  return request(
    `${API_BASE_CATALOG}/srcService/deleteSourceServiceById?${querystring}`
  );
}
/*原服务修改*/
export async function MLZYgetSourceServiceById(query) {
  const querystring = qs.stringify(query);
  return request(
    `${API_BASE_CATALOG}/srcService/getSourceServiceById?${querystring}`
  );
}
...
export async function MLZYdeleteServiceById(query) {
  const querystring = qs.stringify(query);
  return request(
    `${API_BASE_CATALOG}/service/deleteServiceById?${querystring}`
  );
}
...
export async function MLZYgetAllServicePages(query) {
  const querystring = qs.stringify(query);
  return request(
    `${API_BASE_CATALOG}/service/getAllServicePages?${querystring}`
  );
}
...
export async function MLZYdeleteDLRecordById(query) {
  const querystring = qs.stringify(query);
  return request(
    `${API_BASE_CATALOG}/dataUpload/deleteDLRecordById?${querystring}`
  );
}
/*上报数据查询条件*/
export async function MLZYgetAllDateUploadRecords(query) {
  const querystring = qs.stringify(query);
  return request(
    `${API_BASE_CATALOG}/dataUpload/getAllDateUploadRecords?${querystring}`
  );
}
...
export async function MLZYisExistedResourceFile(query) {
  ...
  return request(
    `${API_BASE_CATALOG}/dataUpload/isExistedResourceFile`,
    option
  );
}
...
export async function MLZYsaveOrUpdateUploadData(query) {
  ...
  return request(
    `${API_BASE_CATALOG}/dataUpload/saveOrUpdateUploadData`,
    option
  );
}
...
export async function getETLTaskDetailInfoById(query) {
  const querystring = qs.stringify(query);
  return request(
    `${API_BASE_CATALOG}/dataUpload/getETLTaskDetailInfoById?${querystring}`
  );
}
...
export async function getTempDataUploadRecords(query) {
  const querystring = qs.stringify(query);
  return request(
    `${API_BASE_CATALOG}/dataUpload/getTempDataUploadRecords?${querystring}`
  );
}
...
export async function MLZYupdateBatchDataUploadDetails(query) {
  ...
  return request(
    `${API_BASE_CATALOG}/dataUpload/updateBatchDataUploadDetails`,
    option
  );
}
/*上传文件 数据库类型文件*/
export async function MLZYsaveOrUpdateUploadDataForDB(query) {
  ...
  return request(
    `${API_BASE_CATALOG}/dataUpload/saveOrUpdateUploadDataForDB`,
    option
  );
}
...
export async function deleteTerminalManageRecordById(query) {
  const querystring = qs.stringify(query);
  return request(
    `${API_BASE_CATALOG}/terminalManage/deleteTerminalManageRecordById?${querystring}`
  );
}
...
export async function getTerminalManageRecordsByCondition(query) {
  const querystring = qs.stringify(query);
  return request(
    `${API_BASE_CATALOG}/terminalManage/getTerminalManageRecordsByCondition?${querystring}`
  );
}
/*根据id获取编辑数据*/
export async function getTerminalManageRecordById(query) {
  const querystring = qs.stringify(query);
  return request(
    `${API_BASE_CATALOG}/terminalManage/getTerminalManageRecordById?${querystring}`
  );
}
/*保存数据接口数据*/
export async function saveOrUpdateTerminalManage(query) {
  ...
  return request(
    `${API_BASE_CATALOG}/terminalManage/saveOrUpdateTerminalManage`,
    option
  );
}
...
export async function getDeptServer(query) {
  /*  const querystring = qs.stringify(query);*/
  return request(`${API_BASE_METADATATOSWAP}/getDeptServer/${query}`);
}

/*数据库查询*/
export async function getFSDatabase(query) {
  return request(`${API_BASE_METADATATOSWAP}/getFSDatabase/${query}`);
}
...
export async function isExistedTerminalManageRecord(query) {
  const querystring = qs.stringify(query);
  return request(
    `${API_BASE_CATALOG}/terminalManage/isExistedTerminalManageRecord?${querystring}`
  );
}
...
export async function getAllServiceLog(query) {
  const querystring = qs.stringify(query);
  return request(
    `${API_BASE_CATALOG}/serviceLog/getAllServiceLog?${querystring}`
  );
}
...
export async function getServiceLogDetailById(query) {
  const querystring = qs.stringify(query);
  return request(
    `${API_BASE_CATALOG}/serviceLog/getServiceLogDetailById?${querystring}`
  );
}
...
export async function getResourceShareDict(query) {
  const querystring = qs.stringify(query);
  return request(
    `${API_BASE_CATALOG}/dictionary/getResourceShareDict?${querystring}`
  );
}
...
export async function getResourceTypeDict(query) {
  const querystring = qs.stringify(query);
  return request(
    `${API_BASE_CATALOG}/dictionary/getResourceTypeDict?${querystring}`
  );
}
...
export async function getBrowseFormDataTitle(query) {
  const querystring = qs.stringify(query);
  return request(
    `${API_BASE_CATALOG}/dataUpload/getBrowseFormDataTitle?${querystring}`
  );
}
