...
public class VerifyCodeUtils {
    ...
    private final static Logger logger = Logger.getLogger(VerifyCodeUtils.class);
    ...
    public static void clearVerifyCode() {
        ShiroTokenManager.getSession().removeAttribute(V_CODE);
    }
    ...
    public static boolean verifyCode(String code) {
        String v = (String) ShiroTokenManager.getVal2Session(V_CODE);
        return SecurityStringUtils.equals(v, SecurityStringUtils.lowerCase(code));
    }
    ...
    public static void outputImage(int w, int h, OutputStream os, String code) throws IOException {
        ...
        for (int i = 0; i < verifySize; i++) {
            ...
            affine.setToRotation(Math.PI / 4 * rand.nextDouble() * (rand.nextBoolean() ? 1 : -1), (w / verifySize) * i + fontSize / (double) 2, h / (double) 2);
