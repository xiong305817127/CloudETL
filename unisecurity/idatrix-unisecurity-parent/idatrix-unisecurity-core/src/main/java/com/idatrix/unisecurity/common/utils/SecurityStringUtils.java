 ...
 *
 */
public class SecurityStringUtils extends StringUtils {
    ...
    public static String getBASE64(String str, boolean... bf) {
        if (SecurityStringUtils.isBlank(str)) return null;
        String base64 = null;
        try {
    ...
    public static String mapToGet(Map<? extends Object, ? extends Object> map) {
        ...
        return isBlank(res) ? res : res.substring(0, res.length() - 1);
    }
    ...
    public static String strToUrlcode(String value) {
        try {
            ...
            LoggerUtils.error(SecurityStringUtils.class, "字符串转换为URLCode失败,value:" + value, e);
            e.printStackTrace();
            return null;
        }
    }
    ...
    public static String urlcodeToStr(String value) {
        try {
            ...
            LoggerUtils.error(SecurityStringUtils.class, "URLCode转换为字符串失败;value:" + value, e);
            e.printStackTrace();
            return null;
        }
    }
    ...
    public static List<String> array2Empty(String[] array) {
        ...
        for (String string : array) {
            if (SecurityStringUtils.isNotBlank(string)) {
                list.add(string);
            }
        }
        return list;
