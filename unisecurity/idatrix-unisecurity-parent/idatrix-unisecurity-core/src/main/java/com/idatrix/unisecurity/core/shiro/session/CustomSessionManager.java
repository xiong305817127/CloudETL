...
import com.idatrix.unisecurity.user.bo.UserOnlineBo;
...
public class CustomSessionManager {
    ...
    // session status
    public static final String SESSION_STATUS = "idatrix-online-status";
    ...
    public List<SimplePrincipalCollection> getSimplePrincipalCollectionByUserId(Long... userIds) {
        // 把userIds 转成Set，好判断
        Set<Long> idset = (Set<Long>) SecurityStringUtils.array2Set(userIds);
        // 获取所有session
        Collection<Session> sessions = customShiroSessionDAO.getActiveSessions();
        // 定义返回
