...
public class EncryptUtil {
	    ...
	    public static void main(String[] args) {
	        /*String key1 = "root";
	        String key2 = "10.0.0.88";
	        String key3 = "3306";
	        String data = "Qsde523@@#";
	        
	        
	        String str = EncryptUtil.getInstance().strEnc(data, key1, key2, key3);
	        System.out.println(str);
	        String dec = EncryptUtil.getInstance().strDec(str, key1, key2, key3);
	        ...
	        try {
	          ...
	          engine.eval(new FileReader(path + "EncryptUtil.js"));
	          if (engine instanceof Invocable) {
	            Invocable invocable = (Invocable) engine;
	             Methods executeMethod = invocable.getInterface(Methods.class);
	             
	            str = executeMethod.strEnc(data, key1, key2, key3);
	 	        System.out.println(str);
	 	        dec = executeMethod.strDec(str, key1, key2, key3);
	 	        System.out.println(dec);
			...
			/*String password = EncryptUtil.getInstance().strEnc("admin", "123", "user", null);
			System.out.println(password);//5584658A7DE532542576FC8E63D0E9FE*/

			//Haunting:9A6F99111F180681D8814F8BA80CA424
			String str = EncryptUtil.getInstance().strEnc("a123456", "1191", "sad", null);
			System.out.println(str);
			String password = EncryptUtil.getInstance().strDec("E99CD0719AF68A299E640AD968146323", "1191", "sad", null);
			System.out.println(password);

			//E99CD0719AF68A299E640AD968146323
			//aa5fdf12fc2158a63fe9f297d149e96b
			//

			/*String password = EncryptUtil.getInstance().strDec("9A6F99111F180681D8814F8BA80CA424", "admin", "10.0.0.88", null);
			System.out.println(password);*/
		}
