  ...
  public void readRep( Repository rep, IMetaStore metaStore, ObjectId id_step, List<DatabaseMeta> databases )
    ...
    try {
      ...
      for ( int i = 0; i < nrfiles; i++ ) {
        ...
        //xionghan
        //SPHadoopFileInput  loadSourceRep 方法错误,从getJobEntryAttributeString中获取参数(原生bug),此处她特殊处理
        //String ncName = rep.getJobEntryAttributeString( id_step, i, SOURCE_CONFIGURATION_NAME ); 应该是   String ncName = rep.getStepAttributeString( id_step, i, SOURCE_CONFIGURATION_NAME );
        if( this.getClass().getName().equalsIgnoreCase("org.pentaho.big.data.kettle.plugins.hdfs.trans.HadoopFileInputMeta") ) {
            ...
            Object namedClusterURLMapping = OsgiBundleUtils.getOsgiField(this, "namedClusterURLMapping", true) ;
            inputFiles.fileName[i] =  (String) OsgiBundleUtils.invokeOsgiMethod(this, "loadUrl", source_filefolder, ncName, metaStore, namedClusterURLMapping ) ;
        }
