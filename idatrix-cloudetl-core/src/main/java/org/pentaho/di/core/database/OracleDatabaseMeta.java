...
public class OracleDatabaseMeta extends BaseDatabaseMeta implements DatabaseInterface {
  ...
  public String getURL( String hostname, String port, String databaseName ) throws KettleDatabaseException {
    if ( getAccessType() == DatabaseMeta.TYPE_ACCESS_ODBC ) {
      ...
      // <host>:<port>/<service>
      // <host>:<port>:<SID>
      if ( !Utils.isEmpty( databaseName ) &&  databaseName.startsWith( "/" ) ) {
    	  if(hostname.startsWith("//")) {
    		  return "jdbc:oracle:thin:@" + hostname + ":" + port + databaseName;
    	  }else {
    		  return "jdbc:oracle:thin:@//" + hostname + ":" + port + databaseName;
    	  }
      } else if(  !Utils.isEmpty( databaseName ) && databaseName.startsWith( ":" ) ) {
    	  return "jdbc:oracle:thin:@" + hostname + ":" + port + databaseName;
  ...
  public boolean isQuoteAllFields() {
	  Boolean quoteAllField = IdatrixPropertyUtil.getBooleanProperty("idatrix.database.oracle.quote.all.field",true);
	  if(quoteAllField) {
		  return true;
	  }else {
